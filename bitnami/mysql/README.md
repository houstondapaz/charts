...
| `image.tag`                | MySQL image tag (immutable tags are recommended)                                                                                                                                    | `8.0.28-debian-10-r60` |
...
| `metrics.image.tag`                          | Exporter image tag (immutable tags are recommended)                                                                   | `0.14.0-debian-10-r31`    |
